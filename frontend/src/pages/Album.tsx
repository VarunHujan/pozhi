...
const Album = () => {
  ...
  const handleBuyNow = () => {
    ...
    if (coverType === "custom" && (!frontImage || !backImage)) {
      toast.error("Please upload both front and back cover images", {
        description: "Custom covers require both images to be provided.",
        position: "top-center",
      });
      return;
    }
            ...
            >
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-primary/5 border border-primary/20">
                ...
                <div className="space-y-1">
                    <p className="text-sm font-bold text-heading">Album Content Images</p>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                        Don't worry about uploading all {currentCapacity.images} images here. 
                        Once you place the order, our agency will contact you on <strong>WhatsApp</strong> to collect your high-quality images via Google Drive or Dropbox link.
                    </p>
                </div>
              </div>
