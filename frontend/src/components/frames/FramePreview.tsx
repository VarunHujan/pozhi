...
import type { FrameMaterial, FrameSize } from "@/services/api";

interface FramePreviewProps {
  size: FrameSize;
  material: string; // FrameMaterial is an interface in API, but here we just need string or specific enum if defined
}
