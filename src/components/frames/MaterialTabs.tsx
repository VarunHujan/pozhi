...
import type { FrameMaterial, MaterialOption } from "@/lib/frames-data";

interface MaterialTabsProps {
  materials: MaterialOption[];
  selectedId: FrameMaterial;
  onSelect: (id: FrameMaterial) => void;
}

const MaterialTabs = ({ materials, selectedId, onSelect }: MaterialTabsProps) => {
  return (
