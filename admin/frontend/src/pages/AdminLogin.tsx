...
const AdminLogin = () => {
  const { loginWithGoogle, completeGoogleLogin, completeGoogleLoginWithHash, user } = useAuth();
        ...
        <AnimatePresence>
          {error && (
            <motion.div
              ...
              className="bg-red-50 text-red-600 text-sm px-4 py-3 rounded-xl border border-red-100 flex items-center gap-2 mt-4"
            >
